<?php
$linkMan = $linkFilter = "index.php?com=places&act=man_district";
$linkAdd = "index.php?com=places&act=add_district";
$linkEdit = "index.php?com=places&act=edit_district";
$linkDelete = "index.php?com=places&act=delete_district";
?>
<!-- Content Header -->
                    ...
                    <tbody>
                        <?php for ($i = 0; $i < count($items); $i++) {
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <input type="number" class="form-control form-control-mini m-auto update-numb" min="0" value="<?= $items[$i]['numb'] ?>" data-id="<?= $items[$i]['id'] ?>" data-table="district">
                                </td>
                                <td class="align-middle">
                                ...
                                <?php if (isset($config['places']['check_district'])) {
                                    foreach ($config['places']['check_district'] as $key => $value) { ?>
                                        <td class="align-middle text-center">
                                            <div class="custom-control custom-checkbox my-checkbox">
                                                <input type="checkbox" class="custom-control-input show-checkbox" id="show-checkbox-<?= $key ?>-<?= $items[$i]['id'] ?>" data-table="district" data-id="<?= $items[$i]['id'] ?>" data-attr="<?= $key ?>" <?= (in_array($key, $status_array)) ? 'checked' : '' ?>>
