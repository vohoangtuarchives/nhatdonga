        ...
        <div class="row">
            ...
            <div class="<?= $colRight ?>">
                ...
                <?php if (isset($config['product'][$type]['images_list2']) && $config['product'][$type]['images_list2'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        <div class="card-header">
                            <h3 class="card-title">Hình ảnh 2 <?= $config['product'][$type]['title_main_list'] ?></h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            $photoDetail['dimension'] = "Width: " . $config['product'][$type]['width_list2'] . " px - Height: " . $config['product'][$type]['height_list2'] . " px (" . $config['product'][$type]['img_type_list'] . ")";
