	...
	if ($id) {
		...
		if ($d->update('news_list', $data)) {
			...
			if ($func->hasFile("file2")) {
				...
				if ($photo2 = $func->uploadImage("file2", $config['news'][$type]['img_type_list'], UPLOAD_NEWS, $file_name2)) {
					$row = $d->rawQueryOne("select id, photo2 from #_news_list where id = ? and type = ? limit 0,1", array($id, $type));
					...
					$photoUpdate2['photo2'] = $photo2;
					$d->where('id', $id);
					$d->update('news_list', $photoUpdate2);
					unset($photoUpdate2);
				}
			}
	...
	if ($id) {
		...
		if ($d->update('news_cat', $data)) {
			...
			if ($func->hasFile("file2")) {
				...
				if ($photo2 = $func->uploadImage("file2", $config['news'][$type]['img_type_cat'], UPLOAD_NEWS, $file_name2)) {
					$row = $d->rawQueryOne("select id, photo2 from #_news_cat where id = ? and type = ? limit 0,1", array($id, $type));
					...
					$photoUpdate2['photo2'] = $photo2;
					$d->where('id', $id);
					$d->update('news_cat', $photoUpdate2);
					unset($photoUpdate2);
				}
			}
	...
	if ($id) {
		...
		if ($d->update('news_item', $data)) {
			...
			if ($func->hasFile("file2")) {
				...
				if ($photo2 = $func->uploadImage("file2", $config['news'][$type]['img_type_item'], UPLOAD_NEWS, $file_name2)) {
					$row = $d->rawQueryOne("select id, photo2 from #_news_item where id = ? and type = ? limit 0,1", array($id, $type));
					...
					$photoUpdate2['photo2'] = $photo2;
					$d->where('id', $id);
					$d->update('news_item', $photoUpdate2);
					unset($photoUpdate2);
				}
			}
	...
	if ($id) {
		...
		if ($d->update('news_sub', $data)) {
			...
			if ($func->hasFile("file2")) {
				...
				if ($photo2 = $func->uploadImage("file2", $config['news'][$type]['img_type_sub'], UPLOAD_NEWS, $file_name2)) {
					$row = $d->rawQueryOne("select id, photo2 from #_news_sub where id = ? and type = ? limit 0,1", array($id, $type));
					...
					$photoUpdate2['photo2'] = $photo2;
					$d->where('id', $id);
					$d->update('news_sub', $photoUpdate2);
					unset($photoUpdate2);
				}
			}
