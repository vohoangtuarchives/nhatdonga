...
$config['photo']['photo_static'][$nametype]['check'] = array("hienthi" => "Hiển thị");
$config['photo']['photo_static'][$nametype]['images'] = true;
$config['photo']['photo_static'][$nametype]['width'] = 248;
...
$nametype = "screenshot";
$config['photo']['photo_static'][$nametype]['title_main'] = "Ảnh share Zalo,FB...";
$config['photo']['photo_static'][$nametype]['check'] = array("hienthi" => "Hiển thị");
$config['photo']['photo_static'][$nametype]['images'] = true;
$config['photo']['photo_static'][$nametype]['width'] = 600;
$config['photo']['photo_static'][$nametype]['height'] = 400;
$config['photo']['photo_static'][$nametype]['thumb'] = '600x400x1';
$config['photo']['photo_static'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif';
...
// $config['photo']['photo_static'][$nametype]['name'] = false;
// $config['photo']['photo_static'][$nametype]['desc'] = false;
// $config['photo']['photo_static'][$nametype]['content'] = false;
...
$config['photo']['man_photo'][$nametype]['name_photo'] = false;
$config['photo']['man_photo'][$nametype]['width_photo'] = 1920;
$config['photo']['man_photo'][$nametype]['height_photo'] = 796;
$config['photo']['man_photo'][$nametype]['thumb_photo'] = '1366x610x1';
