...
define("guitinnhan","Gửi tin nhắn");

define("chonfiledinhkem","Chọn file đính kèm (nếu có)");

define("chungtoiluonsansanglangnghe","Chúng tôi luôn sẵn sàng lắng nghe và hỗ trợ bạn");

define("tatsansanpham","Tất cả sản phẩm");

define("bolocvadanhmuc","Bộ lọc & Danh mục");

define("boloc","Bộ lọc");

define("bolocdangapdung","Bộ lọc đang áp dụng:");

define("docthem","Đọc thêm");

define("mucluc","Mục lục");

define("baivietkhongtontai","Bài viết không tồn tại");

define("sanphamkhongtontai","Sản phẩm không tồn tại hoặc đã bị xóa");

define("vuilongquaylaisau","Vui lòng quay lại sau hoặc thử tìm kiếm với từ khóa khác");

define("hienthi","Hiển thị");

define("sanphamthuong","sản phẩm");

define("chungtoikhongtimthaysanpham","Chúng tôi không tìm thấy sản phẩm nào phù hợp với yêu cầu của bạn.");

define("vuilongthulaivoibolockhac","Vui lòng thử lại với bộ lọc khác hoặc quay lại sau.");

define("xemtatcasanpham","Xem tất cả sản phẩm");

define("khongthetaitthongtinsanpham","Không thể tải thông tin sản phẩm. Vui lòng thử lại.");

define("xemnhanhsanpham","Xem nhanh sản phẩm");
