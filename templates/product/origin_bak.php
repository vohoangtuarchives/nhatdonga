...
<?php if (empty($rowDetail)) { ?>
    <div class="section-main">
        <div class="wrapper">
            <div class="container">
                <p class="text-center">Sản phẩm không tồn tại hoặc đã bị xóa.</p>
            </div>
        </div>
    </div>
<?php } else { ?>
    ...
    <div class="wrapper">
        ...
        <div class="container">
            <div class="title-main text-center">
                <h2 class="text-uppercase mb-0 pb-0">
                   <?=$titleMain?>
        ...
        <div class="grid-pro-detail w-clear">
            ...
            <div class="flex-box">
                ...
                <div class="right-pro-detail">
                    ...
                    <p class="title-pro-detail mb-2"><?= !empty($rowDetail) ? ($rowDetail['name' . $lang] ?? '') : '' ?></p>
                        ...
                        <li class="w-clear">
                            ...
                            <div class="attr-content-pro-detail append-price">
                                ...
                                <?php if (!empty($rowDetail) && !empty($rowDetail['sale_price'])) { ?>
                                    ...
                                    <span class="price-old-pro-detail"><?= $func->formatMoney($rowDetail['regular_price'] ?? 0) ?></span>

                                    <span class="discount-pro-detail">(- <?= $rowDetail['discount'] ?? 0 ?>%)</span>

                                <?php } else { ?>

                                    <span class="price-new-pro-detail"><?= (!empty($rowDetail) && !empty($rowDetail['regular_price'])) ? $func->formatMoney($rowDetail['regular_price']) : lienhe ?></span>
                    ...
                    <?php if ($config['cart']['active'] == true) { ?>
                        ...
                        <div class="cart-pro-detail">
                            ...
                            <a class="btn btn-danger addcart mr-2" data-id="<?= $rowDetail['id'] ?>" data-action="addnow">
        ...
        <?php if (!empty($product)) { ?>
            ...
            <?= $custom->titleContainer($titleMain . " khác") ?>
