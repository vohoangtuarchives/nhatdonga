						...
						<div class="col-12 col-lg-6">
							<div class="form-group review-preview">
								<div class="row">
									...
									<div class="col-8">
										...
										<div class="text-split mb-0"><?=htmlspecialchars_decode($rowDetail['desc'.$lang])?></div>
									</div>
								</div>
							</div>
							...
							<?php if($comment->hasMedia) { ?>
								...
								<div class="form-group">
									...
									<div class="review-poster-video-avatar avatar d-flex align-items-center justify-content-start mb-3">
										<div class="avatar-zone mr-3">
											<label class="avatar-label d-block mb-0" id="review-poster-video-label" for="review-poster-video">
												<div class="avatar-detail d-flex align-items-center justify-content-center border rounded overflow-hidden" id="review-poster-video-preview">
